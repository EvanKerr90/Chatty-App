...
<footer className="chatbar" style={{backgroundColor: this.props.appColor}}>
    <input type="text" className="chatbar-username" onChange={this.onChangeUsername} onKeyUp={this.onKeyUpUsername} defaultValue={this.props.currentUser.name}
        placeholder="Your Name (Optional)" />
    <input type="text" className="chatbar-message" value={this.state.message} placeholder="Type a message and hit ENTER" onChange={this.onChangeMessage}
    ...
    <div className="buttons">
        ...
        <span className="change-buttons">
            <input type="button" className="change-button" style={{backgroundColor: this.state.buttonColor.buttonAppColor}} value="app color"
                onClick={this.onClickSelect}/>
            <input type="button" className="change-button" style={{backgroundColor: this.state.buttonColor.buttonUserColor}} value="username color"
                onClick={this.onClickSelect}/>
        </span>
    </div>
</footer>
